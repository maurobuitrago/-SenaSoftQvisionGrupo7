...
public class ShoesPage {
    // SELECT A PRICE TO FILTER SHOES
    public static final Target BTN_SHOES_MENU = Target.the("Button menu nav").locatedBy("//ul[@id='menu-categories-menu']/li[2]/a");
    ...
    public static final Target TXT_RESULT_FILTER = Target.the("Result of process filter").locatedBy("//ul[@class='products columns-3']/li[1]/div/div/div/span/span/bdi/text()");
